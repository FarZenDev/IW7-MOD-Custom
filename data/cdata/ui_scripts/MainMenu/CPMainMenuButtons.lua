...
local f0_local4 = function(arg0, arg1, arg2)
    ...
    arg0.FriendsEasyMPButton:addEventHandler("button_action", function(arg0, arg1)
        LUI.FlowManager.RequestAddMenu("EasyMPFriendsMenu", true, arg1.controller, false)
    end)
...
function CPMainMenuButtons(menu, controller)
    ...
    VNavigator:SetAnchorsAndPosition(0, 1, 0, 1, 0, 500 * _1080p, 0, 440 * _1080p)
    ...
    ButtonDescription:SetAnchorsAndPosition(0, 0, 0, 1, 0, 0, _1080p * 376, _1080p * 434)
    ...
    local FriendsEasyMPButton = nil

    FriendsEasyMPButton = MenuBuilder.BuildRegisteredType("MenuButton", {
        controllerIndex = controllerIndex
    })
    FriendsEasyMPButton.id = "FriendsEasyMPButton"
    FriendsEasyMPButton.buttonDescription = "Hebergez une partie zombies et rejoignez vos amis en quelques clics."
    FriendsEasyMPButton.Text:setText("JOUER ENTRE AMIS", 0)
    FriendsEasyMPButton:SetAnchorsAndPosition(0, 1, 0, 1, 0, _1080p * 340, _1080p * 120, _1080p * 150)
    VNavigator:addElement(FriendsEasyMPButton)
    VNavigator.FriendsEasyMPButton = FriendsEasyMPButton
    ...
    Loadout:SetAnchorsAndPosition(0, 1, 0, 1, 0, _1080p * 340, _1080p * 160, _1080p * 190)
    ...
    Barracks:SetAnchorsAndPosition(0, 1, 0, 1, 0, _1080p * 340, _1080p * 200, _1080p * 230)
    ...
    ModsButton:SetAnchorsAndPosition(0, 1, 0, 1, 0, _1080p * 340, _1080p * 280, _1080p * 310)
    ...
    ContractsButton:SetAnchorsAndPosition(0, 1, 0, 1, 0, _1080p * 340, _1080p * 320, _1080p * 380)
