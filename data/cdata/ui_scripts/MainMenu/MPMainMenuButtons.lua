...
local f0_local3 = function(f2_arg0, f2_arg1, f2_arg2)
    ...
    f2_arg0.FriendsEasyMPButton:addEventHandler("button_action", function(arg0, arg1)
    ...
    if f2_arg0.FriendsEasyMPButton then
        f0_local2(f2_arg0.FriendsEasyMPButton, f2_local5, f2_local6)
    end
...
function MPMainMenuButtons(menu, controller)
    ...
    FriendsEasyMPButton.buttonDescription = "Hebergez une partie et rejoignez vos amis en quelques clics."
    FriendsEasyMPButton.Text:setText("JOUER ENTRE AMIS", 0)
    FriendsEasyMPButton:SetAnchorsAndPosition(0, 1, 0, 1, 0, _1080p * 500, _1080p * 120, _1080p * 150)
    self:addElement(FriendsEasyMPButton)
    self.FriendsEasyMPButton = FriendsEasyMPButton
    ...
    if CONDITIONS.IsStoreAllowed(self) then
        ...
        StoreButton:SetAnchorsAndPosition(0, 1, 0, 1, 0, _1080p * 500, _1080p * 200, _1080p * 230)
